...
token = {
  ...
  getAllPostagens(): Observable<Postagem[]>{
    return this.http.get<Postagem[]>('https://geonarede.herokuapp.com/postagens', this.token)
  }
  ...
  putPostagem(postagem:Postagem): Observable<Postagem>{
    return this.http.put<Postagem>('https://geonarede.herokuapp.com/postagens', postagem, this.token)
  }

  deletePostagem(id: number){
    return this.http.delete(`https://geonarede.herokuapp.com/postagens/${id}`, this.token)
  }
