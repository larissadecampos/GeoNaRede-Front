...
getAllTema(): Observable<Tema[]>{
  return this.http.get<Tema[]>('https://geonarede.herokuapp.com/temas', this.token)
}
...
putTema(tema:Tema): Observable<Tema>{
  return this.http.put<Tema>('https://geonarede.herokuapp.com/temas', tema,this.token)
}

deleteTema(id: number){
  return this.http.delete(`https://geonarede.herokuapp.com/temas/${id}`, this.token)
}
